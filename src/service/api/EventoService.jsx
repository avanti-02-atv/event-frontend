...
export const createEvento = async (data) => {
  try {
    const response = await api.post("/v1/evento", data, {headers: {
...
export const getEventos = async () => {
  try {
    const response = await api.get("/v1/eventos", {headers: {
      'Authorization': `${authToken}`
    } });
...
export const updateEvento = async (id, data) => {
  try {
    const response = await api.put(`/v1/evento/${id}`, data, {headers: {
      'Authorization': `${authToken}`
    } });
    return response.data;
  } catch(err) {
...
export const getEventoById = async (id) => {
  try {
    const response = await api.get(`/v1/evento/${id}`, {headers: {
      'Authorization': `${authToken}`
    } });
    return response.data;
  } catch(err) {
...
export const deleteEvento = async (id) => {
  try {
    const response = await api.delete(`/v1/evento/${id}`, {headers: {
      'Authorization': `${authToken}`
    } });
    return response.data;
  } catch(err) {
