		...
		<div className="flex flex-col min-h-screen bg-white">
			...
			<div className="flex-grow p-6">
				<div className="w-full bg-neutral-50 rounded-lg shadow-lg p-6">
					...
					<h2 className="text-2xl font-black mb-8">Olá <span className="text-orange-300">Visitante</span>, Bem-vindo! </h2>
					...
					<br />
					<h3 className="text-2xl font-black">Com o <span className="text-orange-300">Event</span>Hub, você pode:</h3>
					<p>
						<ul className="list-inside list-none md:list-disc text-xl font-semibold">
							<li>
