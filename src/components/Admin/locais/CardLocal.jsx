  ...
  return (
    <div className="my-12">
      <div className="flex flex-col p-6 justify-start shadow-lg bg-white w-full h-auto rounded-lg border-4 my-4 sm:m-0">
        ...
        <h3 className="text-orange-300 font-black sm:text-lg mb-4">
          <span className="font-black sm:text-lg text-black">CIDADE:</span>{" "}
          <span className="break-all">{cidade}</span>
        </h3>
        <h3 className="text-orange-300 font-black sm:text-lg mb-4">
          <span className="font-black sm:text-lg text-black">CEP:</span>{" "}
          <span className="break-all">{CEP}</span>
        </h3>
        <h3 className="text-orange-300 font-black sm:text-lg mb-4">
          <span className="font-black sm:text-lg text-black">RUA:</span>{" "}
          <span className="break-all">{rua}</span>
        </h3>
        <h3 className="text-orange-300 font-black sm:text-lg mb-4">
          <span className="font-black sm:text-lg text-black">NÚMERO:</span>{" "}
          <span className="break-all">{numero}</span>
        </h3>
